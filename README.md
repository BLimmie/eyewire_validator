...
<img src="https://latex.codecogs.com/gif.latex?loss(\hat{y},&space;u,&space;y)&space;=&space;-{(y\log{(\sigma(\frac{\hat{y}}{u}))}&space;&plus;&space;(1&space;-&space;y)\log{(1&space;-&space;\sigma(\frac{\hat{y}}{u}))})}" />
